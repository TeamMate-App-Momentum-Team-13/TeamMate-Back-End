...
urlpatterns = [
    ...
    path('<str:username>/confirmed-host/', api_views.MyComfirmedHostGameSessions.as_view(), name='comfirmed-host'),
    path('<str:username>/confirmed-guest/', api_views.MyComfirmedGuestGameSessions.as_view(), name='confirmed-guest'),
