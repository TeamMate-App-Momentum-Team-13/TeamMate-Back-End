...
urlpatterns = [
    ...
    path('session/<int:session-pk>/survey/', api_views.ListCreateSurvey.as_view(), name='list-create-survey'),
    path('session/<int:session-pk>/survey/<int:survey-pk>/response', api_views.ListCreateSurveyResponse.as_view(), name='list-create-survey-response'),
